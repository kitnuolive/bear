...
return array(
    ...
    'angsau' =>
    array(
        'bold' => $distFontDir . 'angsau',
        'bold_italic' => $distFontDir . 'angsau',
        'italic' => $distFontDir . 'angsau',
        'normal' => $distFontDir . 'angsau'
    ),
    'proxima nova' =>
    array(
    ...
    'csprakas' =>
    array(
        'bold' => $distFontDir . 'csprakasbold-webfont',
        'bold_italic' => $distFontDir . 'csprakasfdbold-webfont',
        'italic' => $distFontDir . 'csprakasfd-webfont',
        'normal' => $distFontDir . 'csprakas-webfont'
    ),
        )
?>